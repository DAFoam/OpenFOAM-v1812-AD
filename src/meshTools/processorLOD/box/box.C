...
{
    PstreamBuffers pBufs(Pstream::commsTypes::nonBlocking, "Foam::processorLODs::box::setRefineFlags", false);
...
{
    PstreamBuffers pBufs(Pstream::commsTypes::nonBlocking, "Foam::processorLODs::box::doRefineBoxes", false);
